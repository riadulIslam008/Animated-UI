...
class _DiscordUIState extends State<DiscordUI> {
  ...
  Offset _offset = Offset(Get.width> 400? 400* 0.85: Get.width * 0.85, 0);
  double rightSidePadding = - (Get.width> 400? 400* 0.85: Get.width * 0.85);
                                        ...
                                        onPressed: () {
                                          setState(() {
                                            if (!isStateChange) {
                                              ...
                                              _offset =
                                                  Offset(Get.width> 400? 400* 0.85: Get.width * 0.85, 0);
                                              rightSidePadding = _offset.dx;
                                              Future.delayed(
                                                  const Duration(
                                                      milliseconds: 350), () {
